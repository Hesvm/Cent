...
const CATEGORY_KEYWORDS: [string[], string][] = [
  ...
  [['bus', 'buses', 'taxi', 'taxis', 'cab', 'cabs', 'metro', 'tram', 'gvb', 'ret', 'htm', 'ns kaartje', 'bus ticket', 'transit', 'commuter rail', 'lime scooter', 'scooter', 'scooters', 'tier', 'ev charging', 'benzine', 'petrol', 'shell', 'bp', 'uber', 'lyft', 'ride', 'rides', 'ride share', 'car', 'cars', 'train', 'trains', 'subway', 'underground', 'tube', 'bike', 'bikes', 'cycling', 'cycle', 'motorbike', 'motorcycle', 'moto', 'gas station', 'fuel', 'gas', 'transportation', 'تاکسی', 'اتوبوس', 'مترو', 'قطار', 'پرواز', 'بلیط', 'کرایه', 'اوبر', 'بنزین', 'اسنپ'], 'Transport'],
  ...
  [['steam', 'playstation store', 'xbox', 'nintendo', 'in-app purchase', 'game pass', 'ps plus', 'ea play', 'twitch sub', 'epic games', 'gaming gear', 'psn', 'video game', 'game', 'games', 'gaming', 'gaming console', 'console', 'playstation', 'ps4', 'ps5', 'xbox one', 'switch', 'game purchase', 'in-game purchase', 'dlc', 'expansion pack', 'mod', 'بازی', 'ایکس باکس', 'پلی استیشن', 'نینتندو'], 'Gaming'],
  ...
  [['huur', 'huren', 'rent', 'rents', 'hypotheek', 'mortgage', 'mortgages', 'landlord', 'storage unit', 'hoa', 'moving company', 'lease payment', 'tenancy', 'lease', 'leasing', 'apartment', 'apartments', 'house', 'houses', 'flat', 'flats', 'condo', 'condos', 'housing', 'home rental', 'rental', 'housing payment', 'اجاره', 'رهن', 'خانه', 'آپارتمان', 'مسکن', 'ودیعه'], 'Housing & Rent'],
...
const COMPOUND_OVERRIDES: [string[], string][] = [
  ...
  // Persian disambiguation: must come before keyword scan
  [['آب معدنی', 'آب‌معدنی'], 'Groceries'],
  [['شارژ موبایل', 'شارژ ایرانسل', 'شارژ همراه اول', 'شارژ اینترنت', 'شارژ تلفن'], 'Utilities'],
  [['شارژ ساختمان', 'شارژ ماهانه'], 'Housing & Rent'],
