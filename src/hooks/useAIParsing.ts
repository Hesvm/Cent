...
const CATEGORY_KEYWORDS: [string[], string][] = [
  [['pizza', 'pizzas', 'restaurant', 'restauratie', 'pizzeria', 'sushi', 'burger', 'burgers', 'kebab', 'kebabs', 'takeaway', 'takeout', 'food delivery', 'uber eats', 'deliveroo', 'thuisbezorgd', 'just eat', 'doordash', 'snackbar', 'diner', 'buffet', 'steakhouse', 'noodle', 'noodles', 'taco', 'tacos', 'bistro', 'eatery', 'dining', 'lunch', 'dinner', 'breakfast', 'brunch', 'grubhub', 'pasta', 'pastas', 'sandwich', 'sandwiches', 'wrap', 'wraps', 'falafel', 'ramen', 'pho', 'curry', 'thai', 'mexican', 'italian', 'chinese', 'french', 'spanish', 'indian', 'korean', 'japanese', 'vietnamese', 'meal', 'meals', 'food', 'foods', 'eating out'], 'Restaurants & Dining'],
  [['coffee', 'coffees', 'latte', 'lattes', 'espresso', 'americano', 'cappuccino', 'matcha', 'starbucks', 'café', 'cafe', 'cafes', 'bubble tea', 'smoothie bar', 'juice bar', 'koffie', 'flat white', 'costa', 'dutch bros', 'tim hortons', 'tea', 'teas', 'chai', 'mocha', 'coffee shop', 'cafe shop', 'tea shop', 'juice', 'juices', 'smoothie', 'smoothies', 'hot chocolate', 'cocoa'], 'Coffee & Cafés'],
  [['grocery', 'groceries', 'supermarket', 'supermarkten', 'albert heijn', 'lidl', 'aldi', 'jumbo', 'whole foods', 'trader joe', 'kroger', 'picnic', 'hellofresh', 'gorillas', 'getir', 'boodschappen', 'fresh market', 'market', 'markets', 'shopping', 'shop', 'shops', 'store', 'stores', 'food store', 'food shops', 'grocery store', 'supermarkt', 'winkel', 'kruidenierszaak'], 'Groceries'],
  [['bar', 'bars', 'pub', 'pubs', 'kroeg', 'kroegen', 'nightclub', 'nightclubs', 'gall & gall', 'wine shop', 'brewery', 'breweries', 'cocktail bar', 'cocktail bars', 'bottle shop', 'beer', 'beers', 'wine', 'wines', 'whiskey', 'vodka', 'alcohol', 'alcoholic', 'liquor', 'liquors', 'drinking', 'drink', 'drinks'], 'Alcohol & Bars'],
  [['bus', 'buses', 'taxi', 'taxis', 'metro', 'tram', 'gvb', 'ret', 'htm', 'ns kaartje', 'bus ticket', 'transit', 'commuter rail', 'lime scooter', 'scooter', 'scooters', 'tier', 'ev charging', 'benzine', 'petrol', 'shell', 'bp', 'uber', 'lyft', 'ride', 'rides', 'ride share', 'car', 'cars', 'train', 'trains', 'subway', 'underground', 'tube', 'bike', 'bikes', 'cycling', 'cycle', 'motorbike', 'motorcycle', 'moto', 'gas station', 'fuel', 'gas', 'transportation'], 'Transport'],
  [['klm', 'ryanair', 'easyjet', 'booking.com', 'booking', 'airbnb', 'hotel', 'hotels', 'flight', 'flights', 'airplane', 'airfare', 'eurostar', 'car rental', 'rental car', 'hertz', 'avis', 'hostel', 'hostels', 'luggage', 'thalys', 'cruise', 'cruises', 'resort', 'resorts', 'vacation', 'vacations', 'trip', 'trips', 'travel', 'travelling', 'holiday', 'holidays', 'tour', 'tours', 'tourism', 'airport', 'plane', 'planes', 'vliegticket', 'ticket', 'tickets', 'reservations'], 'Travel'],
  [['huisarts', 'dokter', 'doctors', 'dentist', 'dentists', 'tandarts', 'apotheek', 'apotheken', 'pharmacy', 'pharmacies', 'physio', 'physiotherapy', 'optician', 'zorgverzekering', 'vitamins', 'vitamin', 'supplement', 'supplements', 'hospital', 'hospitals', 'ziekenhuis', 'therapist', 'therapy', 'prescription', 'prescriptions', 'blood test', 'test', 'tests', 'health insurance', 'gp', 'nhs', 'clinic', 'clinics', 'specsavers', 'medical', 'medicine', 'medicines', 'doctor visit', 'check-up', 'checkup', 'surgery'], 'Health & Medical'],
  [['gym', 'gyms', 'basic-fit', 'yoga', 'crossfit', 'pilates', 'personal trainer', 'trainer', 'trainers', 'sports club', 'club', 'clubs', 'swimming', 'swim', 'peloton', 'strava', 'marathon', 'fitness', 'fitness app', 'puregym', 'anytime fitness', 'equinox', 'boxing', 'athletic', 'athletics', 'workout', 'workouts', 'exercise', 'exercises', 'sport', 'sports', 'training', 'train', 'running', 'run', 'jogging', 'jog', 'cycling', 'bike', 'biking', 'tennis', 'badminton', 'football', 'soccer', 'basketball', 'volleyball', 'climbing', 'hiking'], 'Fitness & Sports'],
  [['kapper', 'haircut', 'haircuts', 'nail salon', 'nail', 'nails', 'spa', 'spas', 'massage', 'massages', 'barber', 'barbers', 'beauty salon', 'salon', 'salons', 'skincare', 'skin care', 'cosmetics', 'cosmetic', 'waxing', 'wax', 'parfum', 'perfume', 'sephora', 'lush', 'tanning salon', 'tanning', 'eyebrow', 'eyebrows', 'threading', 'makeup', 'hair', 'hairdo', 'grooming', 'groom', 'beauty', 'treatment', 'treatments', 'pedicure', 'manicure'], 'Personal Care & Beauty'],
  [['cinema', 'cinemas', 'pathé', 'concert', 'concerts', 'theater', 'theatre', 'festival', 'festivals', 'ticketmaster', 'escape room', 'escape rooms', 'bowling', 'comedy', 'comedy show', 'pretpark', 'karaoke', 'cineworld', 'odeon', 'imax', 'eventbrite', 'amusement park', 'amusement parks', 'mini golf', 'minigolf', 'arcade', 'arcades', 'show', 'shows', 'show ticket', 'event ticket', 'event', 'events', 'entertainment', 'movie', 'movies', 'film', 'films', 'play', 'plays', 'musical', 'musicals', 'stand-up', 'ticket', 'tickets'], 'Entertainment'],
  [['netflix', 'spotify', 'disney+', 'hbo max', 'apple tv', 'apple music', 'amazon prime video', 'tidal', 'deezer', 'icloud', 'google one', 'youtube premium', 'hulu', 'crunchyroll', 'peacock', 'adobe creative cloud', 'nyt subscription', 'streaming', 'subscription', 'subscriptions', 'subscribe', 'subscription service', 'music streaming', 'video streaming', 'audio streaming', 'premium membership', 'membership', 'memberships', 'monthly subscription', 'annual subscription'], 'Streaming & Subscriptions'],
  [['steam', 'playstation store', 'xbox', 'nintendo', 'in-app purchase', 'game pass', 'ps plus', 'ea play', 'twitch sub', 'epic games', 'gaming gear', 'psn', 'video game', 'game', 'games', 'gaming', 'gaming console', 'console', 'playstation', 'ps4', 'ps5', 'xbox one', 'switch', 'game purchase', 'in-game purchase', 'dlc', 'expansion pack', 'mod'], 'Gaming'],
  [['audible', 'kindle', 'bookstore', 'boekhandel', 'ebook', 'ebooks', 'magazine', 'magazines', 'audiobook', 'audiobooks', 'waterstones', 'library', 'newspaper subscription', 'book', 'books', 'reading', 'novel', 'novels', 'story', 'stories', 'fiction', 'non-fiction', 'author', 'authors', 'publication'], 'Books & Reading'],
  [['huur', 'huren', 'rent', 'rents', 'hypotheek', 'mortgage', 'mortgages', 'landlord', 'storage unit', 'hoa', 'moving company', 'lease payment', 'tenancy', 'lease', 'leasing', 'apartment', 'apartments', 'house', 'houses', 'flat', 'flats', 'condo', 'condos', 'housing', 'home rental', 'rental', 'housing payment'], 'Housing & Rent'],
  [['electricity', 'electric bill', 'water bill', 'gas bill', 'internet bill', 'phone bill', 'utilities', 'utility', 'wifi', 'broadband', 'gemeentebelasting', 'vattenfall', 'nuon', 'kpn', 't-mobile', 'ziggo', 'octopus energy', 'mobile contract', 'bill', 'bills', 'electric', 'water', 'gas', 'internet', 'phone', 'mobile', 'utility bill', 'monthly bill', 'energy bill'], 'Utilities'],
  [['plumber', 'plumbing', 'loodgieter', 'electrician', 'electric', 'handyman', 'cleaning service', 'schoonmaak', 'painter', 'painting', 'renovation', 'renovations', 'garden service', 'gardening', 'pest control', 'hvac', 'locksmith', 'home repair', 'home repairs', 'maintenance', 'fix', 'fixing', 'repair', 'repairs', 'improvement', 'improvements', 'remodel', 'remodeling'], 'Home Maintenance & Repairs'],
  [['vet', 'vets', 'veterinarian', 'dierenarts', 'dog food', 'cat food', 'pet shop', 'pet shops', 'pet grooming', 'grooming', 'pet supplies', 'supplies', 'pet store', 'pet stores', 'boarding', 'doggy daycare', 'petplan', 'pet', 'pets', 'dog', 'dogs', 'cat', 'cats', 'animal', 'animals', 'pet care', 'animal care'], 'Pets'],
  [['kinderopvang', 'daycare', 'daycares', 'babysitter', 'babysitting', 'school fee', 'school fees', 'kindergarten', 'childcare', 'childcare services', 'baby supplies', 'nanny', 'kids activity', 'activities', 'kid', 'kids', 'child', 'children', 'baby', 'babies', 'children activity', 'preschool', 'school'], 'Childcare & Kids'],
  [['zalando', 'zara', 'h&m', 'bol.com', 'ikea', 'mediamarkt', 'coolblue', 'primark', 'uniqlo', 'asos', 'amazon', 'ebay', 'etsy', 'aliexpress', 'online shopping', 'shopping', 'shop', 'shops', 'clothing', 'clothes', 'shoes', 'shoe', 'sneakers', 'furniture', 'electronics', 'electronics store', 'clothing store', 'clothes shop', 'watch', 'watches', 'phone', 'phones', 'laptop', 'laptops', 'headphones', 'headphone', 'jacket', 'jackets', 'dress', 'dresses', 'shirt', 'shirts', 'pants', 'jeans', 'skirt', 'skirts', 'sweater', 'sweaters', 'coat', 'coats', 'boots', 'sandals', 'bag', 'bags', 'handbag', 'handbags', 'accessories', 'accessory', 'home goods', 'household', 'kitchen', 'bed', 'bedding', 'tools', 'tool'], 'Shopping'],
  [['gift', 'gifts', 'cadeau', 'cadeaus', 'birthday present', 'birthday presents', 'gift card', 'gift cards', 'flowers for someone', 'flowers', 'wedding gift', 'wedding gifts', 'celebration dinner', 'present', 'presents', 'occasion', 'occasions', 'special occasion', 'celebration', 'celebrations', 'birthday', 'anniversary', 'wedding', 'anniversaries', 'party', 'parties'], 'Gifts & Occasions'],
  [['donation', 'donations', 'donate', 'donatie', 'charity', 'charities', 'ngo', 'ngos', 'gofundme', 'fundraiser', 'fundraisers', 'church', 'crowdfunding', 'oxfam', 'red cross', 'sponsoring', 'sponsor', 'sponsorship', 'charitable', 'cause', 'causes', 'relief', 'aid', 'helping', 'help'], 'Charity & Donations'],
  [['lend', 'lent', 'borrow', 'borrowed', 'owe', 'owed', 'iou', 'paid back', 'pay back', 'paying back', 'loan to', 'loaned', 'money to', 'money from', 'schuld', 'schuldig', 'geleend', 'geleend van', 'geleend aan', 'geld geleend', 'teruggeven', 'terug betaald', 'loan', 'loans', 'borrowing', 'lending', 'lender', 'borrower', 'debt', 'debts', 'owe money', 'owe someone', 'قرض', 'بدهی'], 'Loans & Lending'],
  [['centraal beheer', 'car insurance', 'home insurance', 'anwb', 'verzekering', 'liability', 'pet insurance', 'contents insurance', 'life insurance', 'travel insurance policy', 'bupa', 'aviva', 'insurance premium', 'insurance', 'insurances', 'insure', 'insured', 'coverage', 'policy', 'policies', 'premium', 'premiums', 'claim', 'claims'], 'Insurance'],
  [['bank fee', 'bank fees', 'atm fee', 'atm fees', 'overdraft', 'overdrafts', 'currency exchange', 'credit card fee', 'credit card fees', 'loan interest', 'bank kosten', 'wire fee', 'kosten rekening', 'transaction fee', 'transaction fees', 'bank', 'banks', 'banking', 'bank account', 'account', 'accounts', 'credit card', 'debit card', 'account fee', 'account fees', 'service fee', 'service fees'], 'Banking & Finance'],
  [['degiro', 'etoro', 'crypto', 'bitcoin', 'cryptocurrencies', 'etf', 'etfs', 'bux', 'brokerage', 'brokerages', 'aandelen', 'investment', 'investments', 'invest', 'investing', 'pension contribution', 'robinhood', 'vanguard', 'trading 212', 'freetrade', 'coinbase', 'revolut invest', 'stock', 'stocks', 'share', 'shares', 'trading', 'trade', 'portfolio', 'investor', 'fund', 'funds'], 'Investments'],
  [['belastingdienst', 'income tax', 'boete', 'passport fee', 'government fee', 'btw', 'vat', 'council tax', 'hmrc', 'municipality fine', 'belasting', 'traffic fine', 'tax', 'taxes', 'taxing', 'fee', 'fees', 'fine', 'fines', 'government', 'municipal', 'municipality', 'tax return', 'tax filing', 'penalty', 'penalties'], 'Government & Taxes'],
  [['coursera', 'udemy', 'masterclass', 'duolingo', 'babbel', 'tuition', 'tuitions', 'cursus', 'textbook', 'textbooks', 'exam fee', 'exam fees', 'tutoring', 'tutoring service', 'linkedin learning', 'skillshare', 'codecademy', 'workshop', 'workshops', 'certification', 'certifications', 'university course', 'course', 'courses', 'class', 'classes', 'training', 'trainings', 'lesson', 'lessons', 'school', 'education', 'learning', 'learn', 'university', 'college', 'academy'], 'Education'],
  [['coworking', 'office supplies', 'office supply', 'kantoor', 'stationery', 'business software', 'postage', 'work laptop', 'wework', 'regus', 'notion', 'figma', 'github', 'slack', 'zoom', 'aws', 'google workspace', 'microsoft 365', 'vercel', 'supabase', 'office', 'offices', 'work', 'work space', 'workspace', 'desk', 'desks', 'chair', 'chairs', 'pen', 'pens', 'paper', 'notebook', 'notebooks', 'paper clip', 'tape', 'business', 'software', 'computer', 'computers'], 'Office & Work Expenses'],
  [['salaris', 'salary', 'salaries', 'loon', 'lonen', 'payroll', 'wages', 'wage', 'paycheck', 'paychecks', 'freelance payment received', 'freelance payment', 'invoice paid', 'employment income', 'employment', 'employer', 'work', 'job', 'jobs', 'income', 'incomes', 'earned', 'earning', 'earnings', 'bonus', 'bonuses', 'salary payment', 'wage payment', 'monthly salary', 'annual salary', 'hiring'], 'Salary & Income'],
  [['fiverr', 'upwork', 'marktplaats', 'vinted', 'freelance', 'freelancers', 'freelance project', 'freelance projects', 'side income', 'side gig', 'side gigs', 'sold item', 'sold items', 'gig pay', 'gig work', 'client payment', 'client payments', 'stripe payout', 'stripe payouts', 'ebay income', 'ebay', 'etsy income', 'etsy', 'selling', 'sell', 'selling items', 'reselling', 'resale', 'project payment', 'contractor', 'contractors', 'contract work', 'task work', 'task payment', 'freelancing', 'consulting', 'consultant', 'independent contractor'], 'Freelance & Side Income'],
  [['airbnb payout', 'airbnb payouts', 'huurinkomsten', 'rental income', 'room rent received', 'room rental', 'property income', 'airbnb host', 'airbnb', 'property rental', 'rental property', 'rent received', 'rental payout', 'tenant payment', 'landlord income', 'lease income', 'housing rental income'], 'Rental Income'],
]
