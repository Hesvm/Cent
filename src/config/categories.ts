...
export const LEGACY_CATEGORY_MAP: Record<string, CategoryName> = {
  ...
  // Accent-stripped variants (AI may drop é)
  'Coffee & Cafes':      'Coffee & Cafés',
  'Coffee and Cafes':    'Coffee & Cafés',
  'Coffee and Cafés':    'Coffee & Cafés',
  // Capitalisation variants
  'restaurants & dining':           'Restaurants & Dining',
  'coffee & cafés':                 'Coffee & Cafés',
  'groceries':                      'Groceries',
  ...
  'education':                      'Education',
  'office & work expenses':         'Office & Work Expenses',
