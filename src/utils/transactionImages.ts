...
const CATEGORY_NAME_TO_SLUG: Record<string, string> = {
  ...
  'Housing & Rent':             'house',
  'Utilities':                  'lightning',
  'Home Maintenance & Repairs': 'house',
  'Pets':                       'dog',
  'Childcare & Kids':           'credit-card',
  'Shopping':                   'shopping-bag',
  ...
  'Investments':                'bank',
  'Government & Taxes':         'receipt',
  'Education':                  'book',
  'Office & Work Expenses':     'laptop',
  'Salary & Income':            'money',
  'Freelance & Side Income':    'money',
  'Rental Income':              'house',
}
